...
# Manual container startup script for authserver production
...
echo -e "${BLUE}🚀 EMERGENCY: Manual startup of authserver production${NC}"
...
podman-compose -f podman-compose.yml --project-name srv up -d
...
echo -e "${GREEN}🎉 Production is running!${NC}"